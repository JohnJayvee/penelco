	...
	<table class="center bg-white" width="55%">
			...
			<tr>
				<th colspan="2"><p style="float: left;text-align: justify;">Hello Customer, <p><br>
					<p style="float: left;text-align: justify;">Good day. We regret to inform you that your request for partial payment has been declined.</p>
				</th>
			</tr>
			<tr>
				<th colspan="2" class="bold"><p style="float: left;text-align: justify;">
					<p style="float: left;text-align: justify;">Reason: {{$remarks}} </p>
				</th>
			</tr>
			<tr class="text-blue">
