...
<div class="row p-3">
  <div class="col-12">
    ...
    <div class="row ">
      ...
      <div class="col-md-6 ">
        <p class="text-dim  float-right">EOR-PHP Processor Portal / For Partial Payment Request List</p>
      </div>
    </div>
      ...
      <table class="table table-striped table-wrap">
        ...
        <tbody>
          ...
          <tr class="text-center">
            ...
            <td>{{Helper::money_format($bill->partial_amount)}} <br> 
              <div>
            ...
            <td>
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuSplitButton2">
                <a class="dropdown-item" href="{{route('system.order_transaction.partial_show',[$bill->id])}}">View transaction</a>
