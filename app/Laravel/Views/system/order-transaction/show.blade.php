            ...
            <table class="table table-striped table-wrap">
              ...
              <tbody>
                ...
                <tr class="text-center">
                  ...
                  <td>{{ Helper::money_format($partial_payment->partial_amount)}} <br> <span class="badge badge-{{Helper::status_badge(Helper::get_partial_status($partial_payment->id))}} p-2">{{Helper::get_partial_status($partial_payment->id)}}</span></td>
                  <td>
