...
return [
    ...
    */
    ...
    'default' => env('DEFAULT_CONNECTION', 'master_db'),
    ...
    */
    ...
    'connections' => [
        ...
        'master_db' => [
            'driver' => env("MASTER_DB_DRIVER","mysql"),
        ...
        'iatf_db' => [
            'driver' => env("IATF_DB_DRIVER","mysql"),
            'url' => env('IATF_DATABASE_URL'),
            'host' => env('IATF_DB_HOST', '127.0.0.1'),
            'port' => env('IATF_DB_PORT', '3306'),
            'database' => env('IATF_DB_DATABASE', 'forge'),
            'username' => env('IATF_DB_USERNAME', 'forge'),
            'password' => env('IATF_DB_PASSWORD', ''),
            'unix_socket' => env('IATF_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        'api_db' => [
            'driver' => env("API_DB_DRIVER","mysql"),
